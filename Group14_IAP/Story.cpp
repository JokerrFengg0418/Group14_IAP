...
void Story::DatabaseInitialisation()
{
        ...
        FactoryCreateQuest("Quest to get 2 Fangs", "      Fang      ", 2);
        CreateNode("StartQuest", 2, 5, 1, "Quest to get 2 Fangs");
        ...
        FactoryCreateChoices(4, 10,
            "Continue story...",
            "Dave: Did ya find any of them Mana Cores around here? The lady up there wants some of that.@Camilla starts to disembark from the carriages. Her assistants rushing elsewhere, mainly towards the black carriage.@",
            0, nullptr, 0);
        CreateNode("CheckQuest", 4, 10, 1, "Collect Mana Core");
        int next0[] = {102};
        FactoryCreateChoices(4, 101,
            ...
            0, next0, 1);
        CreateNode("CheckFlagQuest", 4, 101, 1, "Collect Mana Core");
        ...
        CreateNode("CheckQuest", 4, 101, 1, "Collect Crystal of Power");
        FactoryCreateChoices(4, 102,
            ...
            0, nullptr, 0);
        CreateNode("CheckFlagQuest", 4, 102, 1, "Collect Crystal of Power");
        ...
        FactoryCreateChoices(7, 13,
            ...
            0, next9, 2);
        CreateNode("CheckFlagQuest", 7, 13, 1, "Collect Red Ruby");
